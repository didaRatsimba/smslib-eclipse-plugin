...
{
	public KannelHttp(String myGatewayId, Properties myProps, SMSServer myServer)
	{
	...
	public void create() throws Exception
	{
		...
		if ("yes".equalsIgnoreCase(properties.getProperty(propName + "outbound"))) {
			gateway.setOutbound(true);
		}
		else if ("no".equalsIgnoreCase(properties.getProperty(propName + "outbound"))) {
			gateway.setOutbound(false);
		}
		else {
			throw new Exception("Incorrect parameter: " + propName + "outbound");
		}
		if ("yes".equalsIgnoreCase(properties.getProperty(propName + "autostartsmsc"))) {
			gateway.setAutoStartSmsc(true);
		}
		if ("yes".equalsIgnoreCase(properties.getProperty(propName + "autostopsmsc"))) {
