...
package com.dida.plugin.smslib.org.smslib.smsserver;
...
import com.dida.plugin.smslib.org.smslib.ICallNotification;
import com.dida.plugin.smslib.org.smslib.IInboundMessageNotification;
import com.dida.plugin.smslib.org.smslib.IOrphanedMessageNotification;
import com.dida.plugin.smslib.org.smslib.IOutboundMessageNotification;
import com.dida.plugin.smslib.org.smslib.IQueueSendingNotification;
...
import com.dida.plugin.smslib.org.smslib.helper.Logger;
import com.dida.plugin.smslib.org.smslib.smsserver.gateways.AGateway;
import com.dida.plugin.smslib.org.smslib.smsserver.interfaces.Interface;
import com.dida.plugin.smslib.org.smslib.smsserver.interfaces.Interface.InterfaceTypes;
...
public class SMSServer
{
	...
	private void loadConfiguration() throws Exception
	{
		...
		try
		{
			...
			if (getProperties().getProperty("smsserver.balancer", "").length() > 0)
			{
				try
				{
					Class<?> c = Class.forName((getProperties().getProperty("smsserver.balancer", "").indexOf('.') == -1 ? "com.dida.plugin.smslib.org.smslib.balancing." : "") + getProperties().getProperty("smsserver.balancer", ""));
					Constructor<?> constructor = c.getConstructor();
					com.dida.plugin.smslib.org.smslib.balancing.LoadBalancer balancer = (com.dida.plugin.smslib.org.smslib.balancing.LoadBalancer) constructor.newInstance();
			...
			if (getProperties().getProperty("smsserver.router", "").length() > 0)
			{
				try
				{
					Class<?> c = Class.forName((getProperties().getProperty("smsserver.router", "").indexOf('.') == -1 ? "com.dida.plugin.smslib.org.smslib.routing." : "") + getProperties().getProperty("smsserver.router", ""));
					Constructor<?> constructor = c.getConstructor();
					com.dida.plugin.smslib.org.smslib.routing.Router router = (com.dida.plugin.smslib.org.smslib.routing.Router) constructor.newInstance();
			...
			for (int i = 0; i < Integer.MAX_VALUE; i++)
			{
				try
				{
					...
					Class<?> c = Class.forName((gtwClass.indexOf('.') == -1 ? "com.dida.plugin.smslib.org.smslib.smsserver.gateways." : "") + gtwClass);
			...
			for (int i = 0; i < Integer.MAX_VALUE; i++)
			{
				try
				{
					...
					Class<?> c = Class.forName((infClass.indexOf('.') == -1 ? "com.dida.plugin.smslib.org.smslib.smsserver.interfaces." : "") + infClass);
					Constructor<?> constructor = c.getConstructor(argsClass);
	...
	void sendMessages()
	{
		...
		for (com.dida.plugin.smslib.org.smslib.AGateway gtw : Service.getInstance().getGateways()) {
			if (gtw.isOutbound())
			{
	...
	{
		@Override
		public void process(com.dida.plugin.smslib.org.smslib.AGateway gateway, MessageTypes msgType, InboundMessage msg)
		{
			List<InboundMessage> msgList = new ArrayList<InboundMessage>();
			msgList.add(msg);
			for (Interface<? extends Object> inf : getInfList()) {
	...
	{
		@Override
		public void process(com.dida.plugin.smslib.org.smslib.AGateway gateway, OutboundMessage msg)
		{
			try
			{
				for (Interface<? extends Object> inf : getInfList()) {
	...
	{
		@Override
		public void process(com.dida.plugin.smslib.org.smslib.AGateway gateway, String callerId)
		{
			try
			{
				for (Interface<? extends Object> inf : getInfList()) {
	...
	{
		@Override
		public boolean process(com.dida.plugin.smslib.org.smslib.AGateway gateway, InboundMessage msg)
		{
			System.out.println("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
